...
for train_size in TRAIN_SIZES:
    ...
    # 🔹 SAME SPLIT UTILITY AS OTHER MODELS
    ...
    metrics_path = os.path.join(
        METRICS_DIR,
        f"xgboost_train{train_pct}.json"
    )
...
print("\n🎉 XGBOOST TRAINING COMPLETED FOR ALL SPLITS")
