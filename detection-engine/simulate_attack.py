...
Usage examples:
  python simulate_attack.py udp_flood --target 192.168.1.10 --port 9999 --count 500 --rate 200
  python simulate_attack.py tcp_syn_flood --target 192.168.1.10 --port 80 --count 500 --rate 100
  python simulate_attack.py normal_traffic --target 192.168.1.10 --port 80 --count 200 --rate 50
  python simulate_attack.py mixed --target 192.168.1.10 --port 80 --count 500 --rate 100
"""
